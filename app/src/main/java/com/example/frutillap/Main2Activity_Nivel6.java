...
public class Main2Activity_Nivel6 extends AppCompatActivity {
    ...
    private ImageView iv_Auno, iv_Ado, iv_vidas, iv_signo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_nombre  = (TextView)findViewById(R.id.textView_jugador);
        tv_score  = (TextView)findViewById(R.id.textView_score);
        iv_vidas = (ImageView)findViewById(R.id.imageView_vidas);
        iv_Auno = (ImageView)findViewById(R.id.imageView_num1);
        iv_Ado = (ImageView)findViewById(R.id.imageView_num2);
    ...
    public void BaseDeDatos(){
        ...
        //apertura en modo lectura  escritura DB
        SQLiteDatabase BD = admin.getWritableDatabase();

        //Cursor consulta = BD.rawQuery("select * from puntaje where score = (select max(score) from puntaje",null);
        Cursor consulta = BD.rawQuery("select * from puntaje where score = (select max(score) from puntaje)",null);
        if (consulta.moveToFirst()){ // MovetoFirst nos permite saber si hubo respuesta a nuestra consulta
